...
export const ContractSummaryManager = ({ summary, sessionId, onSuccess, onError }: ContractSummaryManagerProps) => {
    ...
    <div className="border border-base-300 rounded-lg p-4 bg-base-200">
      ...
      <div className="space-y-2 text-sm">
        <div>
          ...
          <span className="ml-2 font-mono text-xs">{userContractAddress || "Not found"}</span>
        </div>
